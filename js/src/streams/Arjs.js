...
export class AssetItemModel extends DOMWidgetModel {
  defaults() {
    return {
      ...super.defaults(),
      _model_module: "jupyter-webrtc",
      _view_module: "jupyter-webrtc",
      _model_name: "AssetItemModel",
      _view_name: "AssetItemView",
      _model_module_version: semver_range,
      _view_module_version: semver_range,
      id: null,
      src: null,
...
export class AssetItemsView extends DOMWidgetView {
  get tagName() {
    return "a-asset-item";
  }
...
AFRAME.registerComponent("resize-for-cell", {
  init: function () {
    var sceneEl = this.el;
  },
});
